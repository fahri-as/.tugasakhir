    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight flex items-center">
                <i class="fas fa-edit text-indigo-600 mr-2"></i> {{ __('Edit Rating Scale') }}
            </h2>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
                <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-indigo-50 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                        <i class="fas fa-star-half-alt text-indigo-600 mr-2"></i> Edit Rating Scale for "{{ $criteria->name }}"
                    </h3>
                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="mb-6 bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg p-4 border border-amber-100 shadow-sm">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <h3 class="text-md font-medium text-amber-900">Editing Rating Scale</h3>
                                <div class="mt-1 flex items-center">
                                    <span class="bg-amber-100 text-amber-800 text-xs font-medium mr-2 px-2.5 py-1 rounded">
                                        Level {{ $ratingScale->rating_level }}
                                    </span>
                                    <span class="font-medium text-gray-900">{{ $ratingScale->name }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
