    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight flex items-center">
                <i class="fas fa-user-edit text-indigo-600 mr-2"></i> {{ __('Edit Applicant') }}
            </h2>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="transform transition duration-200 hover:-translate-y-1">
                                    ...
                                    <div class="relative mt-1">
                                        ...
                                        <input type="text" name="pelamar_id" id="pelamar_id" value="{{ $pelamar->pelamar_id }}" class="pl-10 block w-full rounded-md border-gray-300 bg-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="transform transition duration-200 hover:-translate-y-1">
                                    ...
                                    <div class="relative mt-1">
                                        ...
                                        <input type="text" name="nama" id="nama" value="{{ old('nama', $pelamar->nama) }}" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                    </div>
                                    @error('nama')
                                ...
                                <div class="transform transition duration-200 hover:-translate-y-1">
                                    ...
                                    <div class="relative mt-1">
                                        ...
                                        <input type="email" name="email" id="email" value="{{ old('email', $pelamar->email) }}" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                    </div>
                                    @error('email')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="transform transition duration-200 hover:-translate-y-1">
                                    ...
                                    <div class="relative mt-1">
                                        ...
                                        <input type="text" name="nomor_wa" id="nomor_wa" value="{{ old('nomor_wa', $pelamar->nomor_wa) }}" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                    </div>
                                    @error('nomor_wa')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="transform transition duration-200 hover:-translate-y-1">
                                    ...
                                    <div class="relative mt-1">
                                        ...
                                        <input type="date" name="tgl_lahir" id="tgl_lahir" value="{{ old('tgl_lahir', $pelamar->tgl_lahir ? $pelamar->tgl_lahir->format('Y-m-d') : '') }}" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                    </div>
                                    @error('tgl_lahir')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="md:col-span-2 transform transition duration-200 hover:-translate-y-1">
                                    ...
                                    <div class="relative mt-1">
                                        ...
                                        <textarea name="alamat" id="alamat" rows="3" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>{{ old('alamat', $pelamar->alamat) }}</textarea>
                                    </div>
                                    @error('alamat')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="transform transition duration-200 hover:-translate-y-1">
                                    ...
                                    <div class="relative mt-1">
                                        ...
                                        <select name="job_id" id="job_id" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                ...
                                <div class="transform transition duration-200 hover:-translate-y-1 md:col-span-2">
                                    ...
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Current CV</label>
                                    <div class="flex items-center mb-4 bg-gray-50 p-2 rounded-md border border-gray-200">
                                        <i class="fas fa-file-pdf text-red-500 text-lg mr-2"></i>
                                        <a href="{{ $pelamar->berkas_cv }}" target="_blank" class="text-blue-600 hover:text-blue-800 flex-grow">
                                            View Current CV
                                        </a>
                                    </div>
                                    @endif
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="transform transition duration-200 hover:-translate-y-1">
                                    ...
                                    <div class="relative mt-1">
                                        ...
                                        <input type="number" name="lama_pengalaman" id="lama_pengalaman" value="{{ old('lama_pengalaman', $pelamar->lama_pengalaman) }}" min="0" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                    </div>
                                ...
                                <div class="transform transition duration-200 hover:-translate-y-1">
                                    ...
                                    <div class="relative mt-1">
                                        ...
                                        <input type="text" name="tempat_pengalaman" id="tempat_pengalaman" value="{{ old('tempat_pengalaman', $pelamar->tempat_pengalaman) }}" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                    </div>
                                ...
                                <div class="md:col-span-2 transform transition duration-200 hover:-translate-y-1">
                                    ...
                                    <div class="relative mt-1">
                                        ...
                                        <textarea name="deskripsi_tempat" id="deskripsi_tempat" rows="3" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>{{ old('deskripsi_tempat', $pelamar->deskripsi_tempat) }}</textarea>
                                    </div>
