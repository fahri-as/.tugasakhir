    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight flex items-center">
                <i class="fas fa-star-half-alt text-amber-600 mr-2"></i> {{ __('Create Capability Test Rating Scale') }}
            </h2>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
                <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-amber-50 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                        <i class="fas fa-plus-circle text-amber-600 mr-2"></i> Add New Rating Scale for "{{ $criteria->name }}"
                    </h3>
                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="mb-6 bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg p-4 border border-amber-100 shadow-sm">
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                <h3 class="text-md font-medium text-amber-900">Selected Capability Test Criteria</h3>
                    ...
                    <form method="POST" action="{{ route('tes-kemampuan-rating-scales.store') }}" class="space-y-6">
                        @csrf
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input id="min_score" name="min_score" type="number"
                                        ...
                                        min="0" max="100" value="{{ old('min_score') }}" required>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input id="max_score" name="max_score" type="number"
                                        ...
                                        min="0" max="100" value="{{ old('max_score') }}" required>
                                </div>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        <h3 class="text-lg font-medium text-gray-900 flex items-center mb-4">
                            <i class="fas fa-info-circle text-amber-600 mr-2"></i> Rating Scale Guidelines
                        </h3>

                        <div class="bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg p-4 border border-amber-100 shadow-sm">
                            <div class="grid grid-cols-1 md:grid-cols-5 gap-3">
                                <div class="bg-white p-3 rounded shadow-sm border border-amber-200">
                                    ...
                                    <p class="text-xs text-gray-600">Scores: 0-20</p>
                                </div>
                                <div class="bg-white p-3 rounded shadow-sm border border-amber-200">
                                    <div class="font-medium text-amber-800 flex items-center mb-1">
                                    ...
                                    <p class="text-xs text-gray-600">Scores: 21-40</p>
                                </div>
                                <div class="bg-white p-3 rounded shadow-sm border border-amber-200">
                                    <div class="font-medium text-amber-800 flex items-center mb-1">
                                    ...
                                    <p class="text-xs text-gray-600">Scores: 41-60</p>
                                </div>
                                <div class="bg-white p-3 rounded shadow-sm border border-amber-200">
                                    <div class="font-medium text-amber-800 flex items-center mb-1">
                                    ...
                                    <p class="text-xs text-gray-600">Scores: 61-80</p>
                                </div>
                                <div class="bg-white p-3 rounded shadow-sm border border-amber-200">
                                    <div class="font-medium text-amber-800 flex items-center mb-1">
                                    ...
                                    <p class="text-xs text-gray-600">Scores: 81-100</p>
                                </div>
                            </div>
                        </div>
                    </div>
