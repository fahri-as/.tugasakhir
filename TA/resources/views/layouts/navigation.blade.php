<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('pelamar.index')" :active="request()->routeIs('pelamar.*')">
                        Applicants
                    </x-nav-link>
                    <x-nav-link :href="route('interview.index')" :active="request()->routeIs('interview.*')">
                        Interviews
                    </x-nav-link>
                    <x-nav-link :href="route('tes-kemampuan.index')" :active="request()->routeIs('tes-kemampuan.*')">
                        Skill Tests
                    </x-nav-link>
                    <x-nav-link :href="route('magang.index')" :active="request()->routeIs('magang.*')">
                        Internships
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('pelamar.index')" :active="request()->routeIs('pelamar.*')">
                Applicants
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('interview.index')" :active="request()->routeIs('interview.*')">
                Interviews
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('tes-kemampuan.index')" :active="request()->routeIs('tes-kemampuan.*')">
                Skill Tests
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('magang.index')" :active="request()->routeIs('magang.*')">
                Internships
            </x-responsive-nav-link>
