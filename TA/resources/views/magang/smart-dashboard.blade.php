...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-800">SMART Dashboard for {{ $job->nama_job }}</h1>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden mb-6">
        <div class="p-4">
            <form method="GET" action="{{ route('magang.smartDashboard') }}" class="flex flex-wrap items-end space-x-4">
                <div class="flex-grow">
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden mb-6">
        <div class="p-4">
            <h2 class="text-lg font-medium mb-3">About SMART Evaluation Method</h2>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden mb-6">
        <div class="bg-gray-50 px-4 py-2 border-b flex justify-between items-center">
            <h2 class="font-semibold text-lg">Criteria Weights</h2>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden mb-6">
        <div class="bg-gray-50 px-4 py-2 border-b">
            <h2 class="font-semibold text-lg">Overall SMART Rankings</h2>
        </div>
        <div class="p-4">
            @if($interns->isEmpty())
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead>
                        <tr>
                            ...
                            <th class="px-6 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Intern</th>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden mb-6">
        <div class="bg-gray-50 px-4 py-2 border-b">
            <h2 class="font-semibold text-lg">Weekly Performance Analysis</h2>
        </div>
        <div class="p-4">
            <!-- Week Tabs -->
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr>
                                <th class="px-6 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Rank</th>
                                <th class="px-6 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Intern</th>
                                <th class="px-6 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">SMART Score</th>
                                @foreach($criteria as $criterion)
                                <th class="px-6 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ $criterion->code }}</th>
                                @endforeach
                            </tr>
                        </thead>
                        <tbody>
