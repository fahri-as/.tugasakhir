                                ...
                                <div class="transform transition duration-200 hover:-translate-y-1">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <div class="w-full bg-gray-200 rounded-full h-2">
                                            <div id="score-preview" class="bg-gradient-to-r from-indigo-500 to-purple-500 h-2 rounded-full transition-all duration-300" style="width: {{ ($magang->total_skor / 1) * 100 }}%"></div>
                                        </div>
