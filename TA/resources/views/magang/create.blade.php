<x-crud-layout title="Create Internship Record">
    <form action="{{ route('magang.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="magang_id" id="magang_id" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            @error('magang_id')
