                        ...
                        <form action="{{ route('magang.index') }}" method="GET" id="filter-form">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="search" id="searchh" class="pl-10 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Enter applicant name..." value="{{ request('search') }}">
                                </div>
                            </div>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-yellow-700">
                                        No internship records found. Try adjusting your filters.
                                    </p>
                                </div>
                            </div>
                        </div>
