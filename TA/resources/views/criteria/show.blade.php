            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        ...
                        <form action="{{ route('criteria.destroy', $criterium->criteria_id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this criteria? This action cannot be undone.');">
                            @csrf
                            @method('DELETE')
