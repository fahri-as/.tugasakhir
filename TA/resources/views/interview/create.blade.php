<x-crud-layout title="Schedule Interview">
    <form action="{{ route('interview.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="interview_id" id="interview_id" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            @error('interview_id')
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
            <div>
                ...
                <input type="number" name="kualifikasi_skor" id="kualifikasi_skor" min="1" max="5" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            ...
            <div>
                ...
                <input type="number" name="komunikasi_skor" id="komunikasi_skor" min="1" max="5" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            ...
            <div>
                ...
                <input type="number" name="sikap_skor" id="sikap_skor" min="1" max="5" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                @error('sikap_skor')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
