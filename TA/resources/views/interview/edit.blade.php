<x-crud-layout title="Edit Interview" icon="fa-edit">
    <div class="bg-gradient-to-r from-indigo-50 to-blue-50 p-6 rounded-lg border border-indigo-100 shadow-sm">
        <h3 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200 flex items-center">
            <i class="fas fa-edit text-indigo-600 mr-2"></i> Update Interview Details
        </h3>
        ...
        <form action="{{ route('interview.update', $interview) }}" method="POST" class="space-y-6">
            ...
            <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                <h4 class="text-md font-medium text-gray-800 mb-3 flex items-center">
                    <i class="fas fa-calendar-alt text-indigo-500 mr-2"></i> Interview Schedule
                </h4>
            ...
            <div class="bg-gradient-to-r from-purple-50 to-indigo-50 p-4 rounded-lg border border-purple-100 shadow-sm">
                ...
                <div class="mt-4">
                    <div class="bg-gradient-to-r from-gray-50 to-indigo-50 p-3 rounded-lg border border-gray-200">
                        <div class="flex justify-between items-center">
                            <h5 class="text-sm font-medium text-gray-700 flex items-center">
                                <i class="fas fa-calculator text-indigo-500 mr-2"></i> Total Score
                            </h5>
