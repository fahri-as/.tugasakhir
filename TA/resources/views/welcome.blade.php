                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <form action="{{ route('pelamar.public.store') }}" method="POST" class="space-y-8" enctype="multipart/form-data">
                            ...
                            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                                <h3 class="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">Application Details</h3>
                            ...
                            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                                <h3 class="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">Education & Experience</h3>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <!-- Education -->
                                    <div>
                            ...
                            <!-- CV Upload Section -->
                            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                                <h3 class="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">Document Upload</h3>
