...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2025 at 08:41 PM
...
CREATE TABLE `interview` (
  ...
  KEY `FK_Interview_Pelamar` (`pelamar_id`),
  KEY `FK_Interview_User` (`user_id`),
  KEY `FK_Interview_Job` (`job_id`),
  CONSTRAINT `FK_Interview_Job` FOREIGN KEY (`job_id`) REFERENCES `job` (`job_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_Interview_Pelamar` FOREIGN KEY (`pelamar_id`) REFERENCES `pelamar` (`pelamar_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_Interview_User` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `interview` (`interview_id`, `pelamar_id`, `user_id`, `job_id`, `total_skor`, `jadwal`, `status_seleksi`, `created_at`, `updated_at`) VALUES
('INT001', 'PL001', 1, 'JOB001', 4.00, '2025-05-01 00:00:00', 'Pending', '2025-04-20 05:00:00', '2025-05-06 11:03:27'),
('INT002', 'PL002', 2, 'JOB001', 5.00, '2025-05-02 00:00:00', 'Pending', '2025-04-20 05:00:00', '2025-05-06 11:03:40'),
('INT004', 'PL012', 2, 'JOB004', 0.00, '2025-05-12 10:30:00', 'Tes Kemampuan', '2025-05-11 19:14:27', '2025-05-11 19:43:53'),
('INT005', 'PL011', 2, 'JOB005', 0.00, '2025-05-12 10:35:00', 'Tes Kemampuan', '2025-05-11 19:14:41', '2025-05-11 19:15:45'),
('INT008', 'PL009', 2, 'JOB003', 0.00, '2025-05-12 11:00:00', 'Tes Kemampuan', '2025-05-11 19:58:32', '2025-05-11 20:00:14'),
('INT010', 'PL005', 4, 'JOB001', 3.00, '2025-05-15 01:30:00', 'Tes Kemampuan', '2025-05-13 10:26:12', '2025-05-24 08:24:26'),
('INT012', 'PL010', 2, 'JOB001', 0.00, '2025-05-15 07:30:00', 'Pending', '2025-05-13 16:12:04', '2025-05-13 16:12:04'),
('INT013', 'PL014', 1, 'JOB001', 2.67, '2025-05-14 14:30:00', 'Pending', '2025-05-13 23:10:33', '2025-05-13 23:11:45'),
('INT014', 'PL015', 2, 'JOB001', 0.00, '2025-05-17 20:30:00', 'Tes Kemampuan', '2025-05-17 05:09:24', '2025-05-17 05:09:59'),
('INT015', 'PL003', 1, 'JOB001', 0.00, '2025-05-19 23:30:00', 'Tes Kemampuan', '2025-05-19 08:05:21', '2025-05-19 08:08:43');
...
('3HgKLfsKSP5Uvtpwe2S5pPJ2ZWmVl18QogJV4IgI', 2, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/136.0.0.0 Safari/537.36 Edg/136.0.0.0', '', 1748093686);
...
CREATE TABLE `tes_kemampuan` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`tes_id`),
  KEY `FK_Tes_Kemampuan_User` (`user_id`),
  KEY `FK_Tes_Kemampuan_Pelamar` (`pelamar_id`),
  KEY `FK_Tes_Kemampuan_Job` (`job_id`),
  CONSTRAINT `FK_Tes_Kemampuan_Job` FOREIGN KEY (`job_id`) REFERENCES `job` (`job_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_Tes_Kemampuan_Pelamar` FOREIGN KEY (`pelamar_id`) REFERENCES `pelamar` (`pelamar_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_Tes_Kemampuan_User` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tes_kemampuan` (`tes_id`, `user_id`, `pelamar_id`, `job_id`, `catatan`, `jadwal`, `total_skor`, `status_seleksi`, `created_at`, `updated_at`) VALUES
('TES001', 1, 'PL001', 'JOB001', 'Tes kemampuan memasak dasar.', '2025-05-10 00:00:00', 85, 'Pending', '2025-04-20 05:00:00', '2025-04-20 12:25:02'),
('TES002', 2, 'PL002', 'JOB001', 'Tes kemampuan memasak dasar.', '2025-05-11 00:00:00', 80, 'Pending', '2025-04-20 05:00:00', '2025-04-20 12:25:02'),
('TES006', 2, 'PL011', 'JOB004', NULL, '2025-05-12 10:30:00', 0, 'Magang', '2025-05-11 19:15:45', '2025-05-13 10:09:11'),
('TES008', 2, 'PL012', 'JOB005', NULL, '2025-05-12 11:00:00', 0, 'Magang', '2025-05-11 19:43:53', '2025-05-22 09:22:03'),
('TES010', 2, 'PL009', 'JOB003', NULL, '2025-05-12 11:30:00', 0, 'Lulus', '2025-05-11 20:00:14', '2025-05-13 16:51:50'),
('TES012', 2, 'PL005', 'JOB001', '1w12w', '2025-05-15 01:30:00', 100, 'Magang', '2025-05-13 10:27:39', '2025-05-24 08:36:26'),
('TES013', 2, 'PL015', 'JOB001', NULL, '2025-05-17 20:30:00', 0, 'Magang', '2025-05-17 05:09:59', '2025-05-21 20:33:53'),
('TES014', 1, 'PL003', 'JOB001', NULL, '2025-05-19 23:30:00', 0, 'Pending', '2025-05-19 08:08:43', '2025-05-19 08:08:43');
...
(2, 'cook', '$2y$12$3EqqNgvpwx.97vgLhkv3Q.jxLjCgYKxm2hLhY6pqQE7ZimrS5e0/u', 'cook@perusahaan.com', 'cook', '2025-04-20 05:00:00', '2025-05-24 12:21:57', '7PR0oi4tfAxMkUolqUKgqSW1WxDWVTzWjCjqOwPPU4M4mhZOiniHJTCukPtu'),
...
ALTER TABLE `tes_kemampuan`
  ...
  ADD KEY `FK_Tes_Kemampuan_Job` (`job_id`);
...
--
ALTER TABLE `interview`
  ADD CONSTRAINT `FK_Interview_Job` FOREIGN KEY (`job_id`) REFERENCES `job` (`job_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `tes_kemampuan`
  ADD CONSTRAINT `FK_Tes_Kemampuan_Job` FOREIGN KEY (`job_id`) REFERENCES `job` (`job_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `interview_criteria` (
  ...
  KEY `IDX_Interview_Criteria_Job` (`job_id`),
  CONSTRAINT `FK_Interview_Criteria_Job` FOREIGN KEY (`job_id`) REFERENCES `job` (`job_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Add interview_criteria_rating_scales table
CREATE TABLE `interview_criteria_rating_scales` (
  `id` varchar(50) NOT NULL,
  `criteria_id` varchar(50) NOT NULL,
  `rating_level` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  ...
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_interview_criteria_rating_level` (`criteria_id`,`rating_level`),
  CONSTRAINT `FK_Interview_Rating_Criteria` FOREIGN KEY (`criteria_id`) REFERENCES `interview_criteria` (`criteria_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Add tes_kemampuan_criteria table
CREATE TABLE `tes_kemampuan_criteria` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`criteria_id`),
  KEY `IDX_Tes_Kemampuan_Criteria_Job` (`job_id`),
  CONSTRAINT `FK_Tes_Kemampuan_Criteria_Job` FOREIGN KEY (`job_id`) REFERENCES `job` (`job_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Add tes_kemampuan_criteria_rating_scales table
CREATE TABLE `tes_kemampuan_criteria_rating_scales` (
  `id` varchar(50) NOT NULL,
  `criteria_id` varchar(50) NOT NULL,
  `rating_level` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  ...
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tes_kemampuan_criteria_rating_level` (`criteria_id`,`rating_level`),
  CONSTRAINT `FK_Tes_Kemampuan_Rating_Criteria` FOREIGN KEY (`criteria_id`) REFERENCES `tes_kemampuan_criteria` (`criteria_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Insert sample interview criteria for Cooks job
INSERT INTO `interview_criteria` (`criteria_id`, `job_id`, `name`, `code`, `description`, `weight`) VALUES
('INT_COOK_1', 'JOB001', 'Pengetahuan Memasak', 'IM1', 'Pemahaman tentang teknik memasak, bahan, dan peralatan dapur', 0.4000),
('INT_COOK_2', 'JOB001', 'Komunikasi', 'IM2', 'Kemampuan berkomunikasi dan menyampaikan ide dengan jelas', 0.3000),
('INT_COOK_3', 'JOB001', 'Sikap Profesional', 'IM3', 'Sikap, etika kerja, dan profesionalisme', 0.3000);

-- Insert sample interview rating scales for Cooks criteria
INSERT INTO `interview_criteria_rating_scales` (`id`, `criteria_id`, `rating_level`, `name`, `description`) VALUES
('INT_COOK_1_1', 'INT_COOK_1', 1, 'Sangat Kurang', 'Tidak memiliki pengetahuan dasar tentang memasak'),
('INT_COOK_1_2', 'INT_COOK_1', 2, 'Kurang', 'Memiliki pengetahuan minimal tentang memasak'),
('INT_COOK_1_3', 'INT_COOK_1', 3, 'Cukup', 'Memiliki pengetahuan dasar yang memadai'),
('INT_COOK_1_4', 'INT_COOK_1', 4, 'Baik', 'Memiliki pengetahuan yang baik tentang memasak'),
('INT_COOK_1_5', 'INT_COOK_1', 5, 'Sangat Baik', 'Memiliki pengetahuan yang mendalam tentang memasak');

-- Insert sample tes_kemampuan criteria for Cooks job
INSERT INTO `tes_kemampuan_criteria` (`criteria_id`, `job_id`, `name`, `code`, `description`, `weight`) VALUES
('TES_COOK_1', 'JOB001', 'Teknik Dasar', 'TK1', 'Kemampuan melakukan teknik memasak dasar', 0.4000),
('TES_COOK_2', 'JOB001', 'Kualitas Hasil', 'TK2', 'Kualitas makanan yang dihasilkan', 0.4000),
('TES_COOK_3', 'JOB001', 'Efisiensi', 'TK3', 'Efisiensi waktu dan penggunaan bahan', 0.2000);

-- Insert sample tes_kemampuan rating scales for Cooks criteria
INSERT INTO `tes_kemampuan_criteria_rating_scales` (`id`, `criteria_id`, `rating_level`, `name`, `description`) VALUES
('TES_COOK_1_1', 'TES_COOK_1', 1, 'Sangat Kurang', 'Tidak mampu melakukan teknik dasar memasak'),
('TES_COOK_1_2', 'TES_COOK_1', 2, 'Kurang', 'Dapat melakukan teknik dasar dengan banyak kesalahan'),
('TES_COOK_1_3', 'TES_COOK_1', 3, 'Cukup', 'Dapat melakukan teknik dasar dengan beberapa kesalahan'),
('TES_COOK_1_4', 'TES_COOK_1', 4, 'Baik', 'Dapat melakukan teknik dasar dengan baik'),
('TES_COOK_1_5', 'TES_COOK_1', 5, 'Sangat Baik', 'Menguasai teknik dasar dengan sempurna');

-- Insert interview criteria for Steward job
INSERT INTO `interview_criteria` (`criteria_id`, `job_id`, `name`, `code`, `description`, `weight`) VALUES
('INT_STW_1', 'JOB002', 'Pemahaman Kebersihan', 'IS1', 'Pemahaman tentang standar kebersihan dan sanitasi', 0.4000),
('INT_STW_2', 'JOB002', 'Komunikasi', 'IS2', 'Kemampuan berkomunikasi dan bekerja dalam tim', 0.3000),
('INT_STW_3', 'JOB002', 'Sikap Kerja', 'IS3', 'Sikap, kedisiplinan, dan etos kerja', 0.3000);

-- Insert interview rating scales for Steward criteria
INSERT INTO `interview_criteria_rating_scales` (`id`, `criteria_id`, `rating_level`, `name`, `description`) VALUES
('INT_STW_1_1', 'INT_STW_1', 1, 'Sangat Kurang', 'Tidak memahami standar kebersihan dasar'),
('INT_STW_1_2', 'INT_STW_1', 2, 'Kurang', 'Pemahaman minimal tentang kebersihan'),
('INT_STW_1_3', 'INT_STW_1', 3, 'Cukup', 'Memahami standar kebersihan dasar'),
('INT_STW_1_4', 'INT_STW_1', 4, 'Baik', 'Pemahaman yang baik tentang kebersihan dan sanitasi'),
('INT_STW_1_5', 'INT_STW_1', 5, 'Sangat Baik', 'Pemahaman mendalam tentang kebersihan dan sanitasi'),
('INT_STW_2_1', 'INT_STW_2', 1, 'Sangat Kurang', 'Kesulitan berkomunikasi dan bekerja dengan orang lain'),
('INT_STW_2_2', 'INT_STW_2', 2, 'Kurang', 'Komunikasi terbatas dan kurang kooperatif'),
('INT_STW_2_3', 'INT_STW_2', 3, 'Cukup', 'Dapat berkomunikasi dan bekerja dengan tim'),
('INT_STW_2_4', 'INT_STW_2', 4, 'Baik', 'Komunikasi baik dan kooperatif dalam tim'),
('INT_STW_2_5', 'INT_STW_2', 5, 'Sangat Baik', 'Komunikasi sangat baik dan sangat kooperatif'),
('INT_STW_3_1', 'INT_STW_3', 1, 'Sangat Kurang', 'Sikap kerja sangat buruk'),
('INT_STW_3_2', 'INT_STW_3', 2, 'Kurang', 'Sikap kerja perlu perbaikan'),
('INT_STW_3_3', 'INT_STW_3', 3, 'Cukup', 'Sikap kerja cukup baik'),
('INT_STW_3_4', 'INT_STW_3', 4, 'Baik', 'Sikap kerja baik dan disiplin'),
('INT_STW_3_5', 'INT_STW_3', 5, 'Sangat Baik', 'Sikap kerja sangat baik dan sangat disiplin');

-- Insert tes_kemampuan criteria for Steward job
INSERT INTO `tes_kemampuan_criteria` (`criteria_id`, `job_id`, `name`, `code`, `description`, `weight`) VALUES
('TES_STW_1', 'JOB002', 'Teknik Pembersihan', 'TS1', 'Kemampuan membersihkan peralatan dan area kerja', 0.4000),
('TES_STW_2', 'JOB002', 'Penggunaan Alat', 'TS2', 'Kemampuan menggunakan peralatan kebersihan', 0.3000),
('TES_STW_3', 'JOB002', 'Efisiensi', 'TS3', 'Efisiensi waktu dan penggunaan bahan pembersih', 0.3000);

-- Insert tes_kemampuan rating scales for Steward criteria
INSERT INTO `tes_kemampuan_criteria_rating_scales` (`id`, `criteria_id`, `rating_level`, `name`, `description`) VALUES
('TES_STW_1_1', 'TES_STW_1', 1, 'Sangat Kurang', 'Tidak mampu membersihkan dengan benar'),
('TES_STW_1_2', 'TES_STW_1', 2, 'Kurang', 'Pembersihan tidak menyeluruh'),
('TES_STW_1_3', 'TES_STW_1', 3, 'Cukup', 'Dapat membersihkan dengan cukup baik'),
('TES_STW_1_4', 'TES_STW_1', 4, 'Baik', 'Pembersihan baik dan menyeluruh'),
('TES_STW_1_5', 'TES_STW_1', 5, 'Sangat Baik', 'Pembersihan sangat baik dan sangat menyeluruh');

-- Insert interview criteria for Cook Helper job
INSERT INTO `interview_criteria` (`criteria_id`, `job_id`, `name`, `code`, `description`, `weight`) VALUES
('INT_CH_1', 'JOB003', 'Pengetahuan Dapur', 'ICH1', 'Pemahaman dasar tentang dapur dan peralatan', 0.4000),
('INT_CH_2', 'JOB003', 'Komunikasi', 'ICH2', 'Kemampuan memahami instruksi dan berkomunikasi', 0.3000),
('INT_CH_3', 'JOB003', 'Sikap Kerja', 'ICH3', 'Sikap, kepatuhan, dan kemauan belajar', 0.3000);

-- Insert interview rating scales for Cook Helper criteria
INSERT INTO `interview_criteria_rating_scales` (`id`, `criteria_id`, `rating_level`, `name`, `description`) VALUES
('INT_CH_1_1', 'INT_CH_1', 1, 'Sangat Kurang', 'Tidak memahami dasar-dasar dapur'),
('INT_CH_1_2', 'INT_CH_1', 2, 'Kurang', 'Pemahaman minimal tentang dapur'),
('INT_CH_1_3', 'INT_CH_1', 3, 'Cukup', 'Memahami dasar-dasar dapur'),
('INT_CH_1_4', 'INT_CH_1', 4, 'Baik', 'Pemahaman yang baik tentang dapur'),
('INT_CH_1_5', 'INT_CH_1', 5, 'Sangat Baik', 'Pemahaman mendalam tentang dapur');

-- Insert tes_kemampuan criteria for Cook Helper job
INSERT INTO `tes_kemampuan_criteria` (`criteria_id`, `job_id`, `name`, `code`, `description`, `weight`) VALUES
('TES_CH_1', 'JOB003', 'Persiapan Bahan', 'TCH1', 'Kemampuan menyiapkan bahan masakan', 0.4000),
('TES_CH_2', 'JOB003', 'Penggunaan Alat', 'TCH2', 'Kemampuan menggunakan peralatan dapur', 0.3000),
('TES_CH_3', 'JOB003', 'Kebersihan', 'TCH3', 'Menjaga kebersihan area kerja', 0.3000);

-- Insert tes_kemampuan rating scales for Cook Helper criteria
INSERT INTO `tes_kemampuan_criteria_rating_scales` (`id`, `criteria_id`, `rating_level`, `name`, `description`) VALUES
('TES_CH_1_1', 'TES_CH_1', 1, 'Sangat Kurang', 'Tidak mampu menyiapkan bahan dengan benar'),
('TES_CH_1_2', 'TES_CH_1', 2, 'Kurang', 'Persiapan bahan tidak konsisten'),
('TES_CH_1_3', 'TES_CH_1', 3, 'Cukup', 'Dapat menyiapkan bahan dengan cukup baik'),
('TES_CH_1_4', 'TES_CH_1', 4, 'Baik', 'Persiapan bahan baik dan rapi'),
('TES_CH_1_5', 'TES_CH_1', 5, 'Sangat Baik', 'Persiapan bahan sangat baik dan sangat rapi');

-- Insert interview criteria for Pastry Chef job
INSERT INTO `interview_criteria` (`criteria_id`, `job_id`, `name`, `code`, `description`, `weight`) VALUES
('INT_PST_1', 'JOB004', 'Pengetahuan Pastry', 'IP1', 'Pemahaman tentang teknik dan bahan pastry', 0.4000),
('INT_PST_2', 'JOB004', 'Kreativitas', 'IP2', 'Kreativitas dan inovasi dalam pastry', 0.3000),
('INT_PST_3', 'JOB004', 'Profesionalisme', 'IP3', 'Sikap profesional dan pengalaman', 0.3000);

-- Insert interview rating scales for Pastry Chef criteria
INSERT INTO `interview_criteria_rating_scales` (`id`, `criteria_id`, `rating_level`, `name`, `description`) VALUES
('INT_PST_1_1', 'INT_PST_1', 1, 'Sangat Kurang', 'Tidak memahami dasar-dasar pastry'),
('INT_PST_1_2', 'INT_PST_1', 2, 'Kurang', 'Pemahaman minimal tentang pastry'),
('INT_PST_1_3', 'INT_PST_1', 3, 'Cukup', 'Memahami dasar-dasar pastry'),
('INT_PST_1_4', 'INT_PST_1', 4, 'Baik', 'Pemahaman yang baik tentang pastry'),
('INT_PST_1_5', 'INT_PST_1', 5, 'Sangat Baik', 'Pemahaman mendalam tentang pastry');

-- Insert tes_kemampuan criteria for Pastry Chef job
INSERT INTO `tes_kemampuan_criteria` (`criteria_id`, `job_id`, `name`, `code`, `description`, `weight`) VALUES
('TES_PST_1', 'JOB004', 'Teknik Pastry', 'TP1', 'Kemampuan teknik pembuatan pastry', 0.4000),
('TES_PST_2', 'JOB004', 'Dekorasi', 'TP2', 'Kemampuan dekorasi dan presentasi', 0.3000),
('TES_PST_3', 'JOB004', 'Konsistensi', 'TP3', 'Konsistensi kualitas hasil', 0.3000);

-- Insert tes_kemampuan rating scales for Pastry Chef criteria
INSERT INTO `tes_kemampuan_criteria_rating_scales` (`id`, `criteria_id`, `rating_level`, `name`, `description`) VALUES
('TES_PST_1_1', 'TES_PST_1', 1, 'Sangat Kurang', 'Tidak mampu membuat pastry dengan benar'),
('TES_PST_1_2', 'TES_PST_1', 2, 'Kurang', 'Teknik pastry masih banyak kesalahan'),
('TES_PST_1_3', 'TES_PST_1', 3, 'Cukup', 'Dapat membuat pastry dengan cukup baik'),
('TES_PST_1_4', 'TES_PST_1', 4, 'Baik', 'Teknik pastry baik dan konsisten'),
('TES_PST_1_5', 'TES_PST_1', 5, 'Sangat Baik', 'Teknik pastry sangat baik dan profesional');

-- Insert interview criteria for Barista job
INSERT INTO `interview_criteria` (`criteria_id`, `job_id`, `name`, `code`, `description`, `weight`) VALUES
('INT_BAR_1', 'JOB005', 'Pengetahuan Kopi', 'IB1', 'Pemahaman tentang kopi dan metode penyajian', 0.4000),
('INT_BAR_2', 'JOB005', 'Pelayanan', 'IB2', 'Kemampuan pelayanan dan komunikasi dengan pelanggan', 0.3000),
('INT_BAR_3', 'JOB005', 'Sikap Kerja', 'IB3', 'Sikap profesional dan kerjasama tim', 0.3000);

-- Insert interview rating scales for Barista criteria
INSERT INTO `interview_criteria_rating_scales` (`id`, `criteria_id`, `rating_level`, `name`, `description`) VALUES
('INT_BAR_1_1', 'INT_BAR_1', 1, 'Sangat Kurang', 'Tidak memahami dasar-dasar kopi'),
('INT_BAR_1_2', 'INT_BAR_1', 2, 'Kurang', 'Pemahaman minimal tentang kopi'),
('INT_BAR_1_3', 'INT_BAR_1', 3, 'Cukup', 'Memahami dasar-dasar kopi'),
('INT_BAR_1_4', 'INT_BAR_1', 4, 'Baik', 'Pemahaman yang baik tentang kopi'),
('INT_BAR_1_5', 'INT_BAR_1', 5, 'Sangat Baik', 'Pemahaman mendalam tentang kopi');

-- Insert tes_kemampuan criteria for Barista job
INSERT INTO `tes_kemampuan_criteria` (`criteria_id`, `job_id`, `name`, `code`, `description`, `weight`) VALUES
('TES_BAR_1', 'JOB005', 'Teknik Brewing', 'TB1', 'Kemampuan teknik pembuatan kopi', 0.4000),
('TES_BAR_2', 'JOB005', 'Latte Art', 'TB2', 'Kemampuan membuat latte art', 0.3000),
('TES_BAR_3', 'JOB005', 'Kebersihan', 'TB3', 'Kebersihan dan maintenance mesin', 0.3000);

-- Insert tes_kemampuan rating scales for Barista criteria
INSERT INTO `tes_kemampuan_criteria_rating_scales` (`id`, `criteria_id`, `rating_level`, `name`, `description`) VALUES
('TES_BAR_1_1', 'TES_BAR_1', 1, 'Sangat Kurang', 'Tidak mampu membuat kopi dengan benar'),
('TES_BAR_1_2', 'TES_BAR_1', 2, 'Kurang', 'Teknik brewing masih banyak kesalahan'),
('TES_BAR_1_3', 'TES_BAR_1', 3, 'Cukup', 'Dapat membuat kopi dengan cukup baik'),
('TES_BAR_1_4', 'TES_BAR_1', 4, 'Baik', 'Teknik brewing baik dan konsisten'),
('TES_BAR_1_5', 'TES_BAR_1', 5, 'Sangat Baik', 'Teknik brewing sangat baik dan profesional');
